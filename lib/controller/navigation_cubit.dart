...
class NavigationCubit extends Cubit<NavigationState> {
  ...
  void getNavBarItem2(int index) {

    switch (index) {
      case 0:
        emit(const NavigationState(bottomNavItems: Routes.homeDetailsNamedPage,index:  0));
        break;
      case 1:
        emit(const NavigationState(bottomNavItems: Routes.profileDetailsNamedPage,index:  1));
        break;
      case 2:
        emit(const NavigationState(bottomNavItems: Routes.settingsNamedPage,index:  2));
        break;
